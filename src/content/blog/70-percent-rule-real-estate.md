---
title: "The 70% Rule in Real Estate: Screen, Then Underwrite"
description: "The 70% rule is a rough fix-and-flip screening heuristic, not a complete offer formula. Market conditions, financing, scope, selling costs, taxes, hold…"
plannedPublishDate: "2027-01-21"
targetKeyword: "70 percent rule real estate"
cluster: "Deal analysis"
intent: "Learn"
funnel: "Awareness"
audience: "New investors learning quick deal screens"
...
The 70% rule is a rough fix-and-flip screening heuristic, not a complete offer formula. Market conditions, financing, scope, selling costs, taxes, hold time, and required profit can make the shortcut too aggressive or too conservative.
...
### 1. The assumptions hidden inside the percentage
...
### 2. Local resale and transaction-cost conditions

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. A full project model before making a binding commitment
...
- What evidence supports **the assumptions hidden inside the percentage**?
- What evidence supports **local resale and transaction-cost conditions**?
- What evidence supports **a full project model before making a binding commitment**?
