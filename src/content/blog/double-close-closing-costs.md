---
title: "What Costs Belong in a Double-Close Analysis?"
description: "A double close can create costs on both transactions, including title or attorney charges, transfer or recording charges, transactional funding fees, wire…"
plannedPublishDate: "2026-10-20"
targetKeyword: "double close closing costs"
cluster: "Transactional funding"
intent: "Learn"
funnel: "Consideration"
audience: "Wholesalers testing whether a double close still works"
...
A double close can create costs on both transactions, including title or attorney charges, transfer or recording charges, transactional funding fees, wire fees, and other settlement items. The investor should model actual written estimates rather than a generic percentage.
...
### 1. Two settlement statements instead of one
...
### 2. Funding charges tied to amount and duration

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Tax, recording, title, and local transaction costs
...
- What evidence supports **two settlement statements instead of one**?
- What evidence supports **funding charges tied to amount and duration**?
- What evidence supports **tax, recording, title, and local transaction costs**?
