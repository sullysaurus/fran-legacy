---
title: "Is Earnest Money Refundable? Start With the Contract"
description: "Earnest money may be refundable when a buyer terminates within a valid contingency or another contractual right. It may become nonrefundable after a…"
plannedPublishDate: "2026-09-10"
targetKeyword: "is earnest money refundable"
cluster: "Earnest money"
intent: "Solve"
funnel: "Consideration"
audience: "Buyers deciding whether a deposit is exposed"
...
Earnest money may be refundable when a buyer terminates within a valid contingency or another contractual right. It may become nonrefundable after a deadline, waiver, or default. The signed agreement and applicable law—not a general rule—control the result.
...
### 2. The exact notice and delivery requirements for termination

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Whether the parties dispute the escrow agent’s authority to release funds
...
- What evidence supports **which contingencies remain open**?
- What evidence supports **the exact notice and delivery requirements for termination**?
- What evidence supports **whether the parties dispute the escrow agent’s authority to release funds**?
