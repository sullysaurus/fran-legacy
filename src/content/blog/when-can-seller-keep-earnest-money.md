---
title: "When Can a Seller Keep Earnest Money?"
description: "A seller may have a claim to earnest money after a buyer default or another event defined in the contract. Whether the seller actually receives it can…"
plannedPublishDate: "2026-10-01"
targetKeyword: "when can seller keep earnest money"
cluster: "Earnest money"
intent: "Solve"
funnel: "Consideration"
audience: "Investors assessing deposit-loss scenarios"
...
A seller may have a claim to earnest money after a buyer default or another event defined in the contract. Whether the seller actually receives it can depend on notice, cure rights, escrow instructions, dispute procedures, and applicable law.
...
For investors assessing deposit-loss scenarios, the practical question is not only “what does this term mean?” It is “which decision does it change, which document controls that decision, and what happens if the expected path fails?” That framing keeps education connected to the actual transaction without pretending that one article can replace underwriting or professional advice.

Keywords Everywhere estimated 140 U.S. searches per month when collected on August 28, 2026. Search volume is an estimate and paid-search competition is not organic ranking difficulty. The topic belongs in this plan because its search intent is distinct and it supports a verified Fran Legacy conversation.

## Three points to verify

### 1. The default and liquidated-damages language
...
### 2. Whether a valid contingency protected the buyer

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. The procedure the escrow holder must follow when parties disagree
...
- What evidence supports **the default and liquidated-damages language**?
- What evidence supports **whether a valid contingency protected the buyer**?
- What evidence supports **the procedure the escrow holder must follow when parties disagree**?
