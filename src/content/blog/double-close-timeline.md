---
title: "A Double-Close Timeline From Contract to Two Settlements"
description: "A double close requires two coordinated transactions: the original seller transfers to the investor, then the investor transfers to the end buyer. The…"
plannedPublishDate: "2026-10-15"
targetKeyword: "double close timeline"
cluster: "Transactional funding"
intent: "Learn"
funnel: "Decision"
audience: "Wholesalers coordinating an A-B and B-C closing"
...
A double close requires two coordinated transactions: the original seller transfers to the investor, then the investor transfers to the end buyer. The title team, funder, contracts, settlement statements, and wire timing must align before either closing is treated as ready.
...
### 1. Title and payoff work for the A-B closing
...
### 2. End-buyer funds and conditions for the B-C closing

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Wire cutoffs, recording order, and contingency time
...
- What evidence supports **title and payoff work for the A-B closing**?
- What evidence supports **end-buyer funds and conditions for the B-C closing**?
- What evidence supports **wire cutoffs, recording order, and contingency time**?
