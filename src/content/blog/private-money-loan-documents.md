---
title: "Private Money Loan Documents: A Borrower’s Checklist"
description: "Private real estate loans require more than a handshake. The file may include an application, entity records, purchase contract, valuation, scope and…"
plannedPublishDate: "2026-11-19"
targetKeyword: "private money loan documents"
cluster: "Private lending"
intent: "Solve"
funnel: "Decision"
audience: "Borrowers preparing for underwriting and closing"
...
Private real estate loans require more than a handshake. The file may include an application, entity records, purchase contract, valuation, scope and budget, title work, insurance, a promissory note, security documents, guarantees, and closing instructions.
...
### 1. Documents that establish the borrower and entity
...
### 2. Documents that support value, budget, and exit

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Loan and collateral documents prepared for the jurisdiction
...
- What evidence supports **documents that establish the borrower and entity**?
- What evidence supports **documents that support value, budget, and exit**?
- What evidence supports **loan and collateral documents prepared for the jurisdiction**?
