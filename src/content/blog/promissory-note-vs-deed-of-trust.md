---
title: "Promissory Note vs. Deed of Trust"
description: "A promissory note states the debt obligation and repayment terms. A deed of trust or mortgage creates a security interest in real property, subject to…"
plannedPublishDate: "2026-12-15"
targetKeyword: "promissory note vs deed of trust"
cluster: "Private lending"
intent: "Compare"
funnel: "Awareness"
audience: "Borrowers learning core loan documents"
...
A promissory note states the debt obligation and repayment terms. A deed of trust or mortgage creates a security interest in real property, subject to state law and proper execution and recording. They work together but do different jobs.
...
### 1. The payment promise in the note
...
### 2. The collateral rights in the security instrument

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. State-specific signing, notarization, and recording requirements
...
- What evidence supports **the payment promise in the note**?
- What evidence supports **the collateral rights in the security instrument**?
- What evidence supports **state-specific signing, notarization, and recording requirements**?
