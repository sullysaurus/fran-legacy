---
title: "Private Money Loan Terms Investors Should Compare"
description: "A private loan term sheet should be evaluated as a system: principal, interest, points and fees, term, payments, draws, reserves, collateral, lien…"
plannedPublishDate: "2026-11-24"
targetKeyword: "private money loan terms"
cluster: "Private lending"
intent: "Compare"
funnel: "Consideration"
audience: "Borrowers comparing term sheets"
...
A private loan term sheet should be evaluated as a system: principal, interest, points and fees, term, payments, draws, reserves, collateral, lien position, recourse, extension rights, default terms, and exit requirements all affect the deal.
...
### 1. All-in cost rather than the stated rate alone
...
### 2. Cash timing for fees, interest, and construction draws

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Extension, default, prepayment, and payoff mechanics
...
- What evidence supports **all-in cost rather than the stated rate alone**?
- What evidence supports **cash timing for fees, interest, and construction draws**?
- What evidence supports **extension, default, prepayment, and payoff mechanics**?
