---
title: "Who Holds Earnest Money Before Closing?"
description: "Earnest money is commonly held by a named escrow agent, title company, closing attorney, broker trust account, or another party authorized by the contract…"
plannedPublishDate: "2026-09-29"
targetKeyword: "who holds earnest money"
cluster: "Earnest money"
intent: "Learn"
funnel: "Awareness"
audience: "Buyers who want to verify where deposit funds go"
...
Earnest money is commonly held by a named escrow agent, title company, closing attorney, broker trust account, or another party authorized by the contract and local rules. A buyer should never assume wiring instructions are legitimate without independent verification.
...
### 1. The holder named in the signed agreement
...
### 2. Fraud-resistant verification of wire instructions

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. The receipt and written escrow record
...
- What evidence supports **the holder named in the signed agreement**?
- What evidence supports **fraud-resistant verification of wire instructions**?
- What evidence supports **the receipt and written escrow record**?
