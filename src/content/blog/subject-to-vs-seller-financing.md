---
title: "Subject-To vs. Seller Financing"
description: "Subject-to typically leaves an existing third-party loan in place after title transfers. Seller financing creates a new debt obligation from buyer to…"
plannedPublishDate: "2027-02-16"
targetKeyword: "subject to vs seller financing"
cluster: "Creative acquisition"
intent: "Compare"
funnel: "Consideration"
audience: "Buyers and sellers comparing creative structures"
...
Subject-to typically leaves an existing third-party loan in place after title transfers. Seller financing creates a new debt obligation from buyer to seller. They can sometimes appear in the same capital stack, but their risks and documents are different.
...
### 1. Who is owed money after closing
...
### 2. Which existing or new liens remain on the property

Write the answer into the deal file and attach the source document. If the answer depends on a verbal promise, future approval, or an unverified estimate, treat it as an open condition rather than a completed fact.

### 3. Payment servicing, maturity, default, insurance, and exit obligations
...
- What evidence supports **who is owed money after closing**?
- What evidence supports **which existing or new liens remain on the property**?
- What evidence supports **payment servicing, maturity, default, insurance, and exit obligations**?
